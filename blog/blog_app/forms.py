...
class LoginForm(AuthenticationForm):
    username = forms.CharField(max_length=20, required=True, help_text='Enter your username')
    password=forms.CharField(min_length=8, required=True, widget=forms.PasswordInput, help_text='Enter your password')
