...
class LoginForm(AuthenticationForm):
    username = forms.CharField(max_length=20, required=True, widget=forms.TextInput({"placeholder" : "Enter your username"}))
    password=forms.CharField(min_length=8, required=True, widget=forms.PasswordInput({'placeholder':'Enter your password'}))
